...
1. 老师创建活动，填写名称、地点、时间、容量、报名截止时间和报名字段。
2. 系统发布活动并同步到学生端活动列表。
3. 学生查看活动详情，在截止时间前提交报名。
4. 系统完成截止时间、重复报名和容量校验。
5. 老师在后台查看报名人数和名单明细。
6. 活动前老师导出名单，用于现场签到和归档。

## 6. 验收标准

- 老师发布活动后，学生端能在 1 秒内看到活动。
- 学生重复报名同一活动时，系统应阻止并给出明确提示。
- 超过报名截止时间后，报名按钮不可用，且后端接口拒绝新增报名。
- 老师导出的报名名单与后台统计人数一致。
- 学生无权查看他人报名信息，老师无权管理非自己发布的活动。
