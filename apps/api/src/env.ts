...
const envSchema = z.object({
  ...
  TASK_STATE_PATH: z.string().default(".data/tasks.json"),
...
export const config = {
  ...
  taskStatePath: parsed.TASK_STATE_PATH,
  larkCliTimeoutMs: parsed.LARK_CLI_TIMEOUT_MS,
  larkCliReadRetries: parsed.LARK_CLI_READ_RETRIES,
